...
tforecast=datenum(2015,01,01);   % the time when data asssimilation is turned off
tforecast2=datenum(2020,01,01);  % the time transition from a hindcast to a forecast (usually when no more data is available)
...
HOLD_THE_LINE=0; CONTINUED_ACCRETION=1; OUTPUT_DIR='results\ManagmentCase4_no_hold_the_line_continued_accretion';
